    ...
    <section id='testimonials' className="c-space my-20">
      ...
      <div className="client-container ">
        {clientReviews.map((item) => (
          <div key={`review-${item.id}`} className="client-review bg-opacity-50 rounded-lg border border-gray-600 hover:border-green-500 focus:ring-1 hover:ring-green-500 text-white transition-duration-200">
            <div>
